...
import (
	"errors"
	"fmt"
	"github.com/Prashanth684/releasecontroller-mcp-server/pkg/mcp"
...
var rootCmd = &cobra.Command{
	Use:   "releasecontroller-mcp-server [command] [options]",
	Short: "releasecontroller Model Context Protocol (MCP) server",
	Long: `
releasecontroller Model Context Protocol (MCP) server

  # show this help
  releasecontroller-mcp-server -h

  # shows version information
  releasecontroller-mcp-server --version
  ...
  releasecontroller-mcp-server --sse-port 8443 --sse-base-url https://example.com:8443
